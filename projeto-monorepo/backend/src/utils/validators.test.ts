...
describe('Módulo de Validação: validators.ts', () => {
  describe('Função isValidEmail', () => {
    it('Deve retornar true para um endereço de email válido AAA (Arrange, Act, Assert', () => {
      // 1. Arrange (Preparar)
  ...
  describe('Função isStrongPassoword', () => {
    ...
    it('Deve rejeitar senhas sem letras maiúsculas', () => {
        ...
        const result = isStrongPassword(lowerCasePassword);
        expect(result).toBe(false);
    });
